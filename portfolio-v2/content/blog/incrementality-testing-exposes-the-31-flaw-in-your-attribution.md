---
title: "Incrementality Testing Exposes the 31% Flaw in Your Attribution"
description: "An incrementality study across 150 experiments shows only 69% of last-click attributed conversions are actually caused by paid channels. Here's the math, the method, and how to run your first holdout test."
date: "2026-09-17"
tags: ["marketing analytics", "attribution", "incrementality testing", "B2B SaaS", "marketing measurement", "paid media", "MMM"]
author: "Karan Sud"
accent: "violet"
source: "blog-posts/2026-09-17"
---
*31% of your conversions aren't real. Here's how to find out which ones.*

![Abstract bar chart showing two sets of bars per channel — grey reported conversions versus shorter red incremental conversions — against a dark navy background, visualizing the attribution gap in marketing measurement.](/blog/incrementality-testing-exposes-the-31-flaw-in-your-attribution/hero.jpg)
...
<figure class="chart-embed">
  <iframe src="/blog/incrementality-testing-exposes-the-31-flaw-in-your-attribution/chart1.html" title="Incrementality Testing Exposes the 31% Flaw in Your Attribution chart 1" loading="lazy" scrolling="no"></iframe>
</figure>
...
<figure class="chart-embed">
  <iframe src="/blog/incrementality-testing-exposes-the-31-flaw-in-your-attribution/chart2.html" title="Incrementality Testing Exposes the 31% Flaw in Your Attribution chart 2" loading="lazy" scrolling="no"></iframe>
</figure>
...
![Incrementality Testing Exposes the 31% Flaw in Your Attribution](/blog/incrementality-testing-exposes-the-31-flaw-in-your-attribution/infographic.svg)
